 ...
 */
// TODO en entier 
public class AchievementHandler extends DefaultHandler
{
	...
	throws SAXException
	{
		...
		if(qName.equals("ArtifactCollections"))
			this.artifactList = new LinkedList<Achievement>();
		else if(qName.equals("ArtifactCollection"))
			this.artifact = new Achievement();
...
//		if(this.buffer != null)
	...
	public List<Achievement> getArtifact() throws SAXException
	{
		if(!this.isReady)
	...
	private List<Achievement> artifactList; //résultats de notre parsing
	private Achievement artifact; // Objet en cours
