...
// TODO en entier
public class GenerateArtifactSql
{
	public static void generateSql(List<Artifact> listRecipe, String fileName)
	{
		try
		{
			...
			for(Artifact recipe:listRecipe)
	...
	public static String generateSql(Artifact recipe)
	{
